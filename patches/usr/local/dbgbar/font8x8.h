/*
 * font8x8.h  --  Minimal public-domain 8x8 bitmap font (printable ASCII subset)
 *
 * Bit layout: font8x8[c - 0x20] is 8 rows (top -> bottom).
 * In each row byte, bit 0 (LSB) is the LEFT-most pixel, bit 7 the right-most.
 * The renderer upsamples 1x or 2x. Lowercase is mapped to uppercase by the
 * renderer, so only 0x20..0x5F need to be legible; the rest are best-effort.
 *
 * Derived from the widely distributed "font8x8_basic" (public domain).
 */
#ifndef DBGBAR_FONT8X8_H
#define DBGBAR_FONT8X8_H
...
/* 0x57 'W' */ {0x63,0x63,0x6B,0x7F,0x7F,0x77,0x63,0x00},
...
/* 0x60 '`' */ {0x0C,0x0C,0x18,0x00,0x00,0x00,0x00,0x00}, /* remapped to degree glyph in renderer */
...
/* Custom "degree" glyph (small ring, top-left) -- selected by passing 0x60 (`) */
static const unsigned char font_degree[8] =
    {0x1C,0x36,0x36,0x1C,0x00,0x00,0x00,0x00};

#endif /* DBGBAR_FONT8X8_H */
